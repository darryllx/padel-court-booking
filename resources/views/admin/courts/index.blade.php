        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                function fetchCourts() {
                    ...
                    const url = `{{ route('courts.index') }}?search=${search}&category_id=${category}&is_available=${availability}`;
                ...
                // Event Listeners
                if (searchInput) searchInput.addEventListener('input', debounce(fetchCourts, 500));
                if (categorySelect) categorySelect.addEventListener('change', fetchCourts);
                if (availabilitySelect) availabilitySelect.addEventListener('change', fetchCourts);
            });
        </script>
    @endpush
    </div>
